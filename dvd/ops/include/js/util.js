        ...
        if (inViewer()) {
          if (!isSub) getViewerApi('GO_PAGE_NAME_LOAD')(`${pageName}.html`);
            ...
            if (window.jj && jj.native.exe) {
              jj.link.html(`/viewer/contents/index.html?contentInformationURL=../../resource/contents/${lesson}/&pageName=${pageName}.html&UUID=fcem:uuid:contents${sliderPage ? '?slider=' + sliderPage : ''}`, '_top');
            }
            else {
              window.open(`../../../../viewer/contents/index.html?contentInformationURL=../../resource/contents/${lesson}/&pageName=${pageName}.html&UUID=fcem:uuid:contents${sliderPage ? '?slider=' + sliderPage : ''}`, '_top');
            }
          }
        }
      ...
      case 'sub':
        if (inViewer()) {
          if (isSub) getViewerApi('GO_PAGE_NAME_LOAD')(`${pageName}.html`);
            ...
            if (window.jj && jj.native.exe) {
              jj.link.html(`/viewer/contents/index.html?contentInformationURL=../../resource/contents_sub/${lesson}/&pageName=${pageName}.html&UUID=fcem:uuid:contents${sliderPage ? '?slider=' + sliderPage : ''}`, '_top');
            }
            else {
              window.open(`../../../../viewer/contents/index.html?contentInformationURL=../../resource/contents_sub/${lesson}/&pageName=${pageName}.html&UUID=fcem:uuid:contents${sliderPage ? '?slider=' + sliderPage : ''}`, '_top');
            }
          }
        }
